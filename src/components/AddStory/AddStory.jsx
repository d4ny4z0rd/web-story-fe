...
const AddStory = () => {
		...
		if (id) {
			const getPost = async () => {
				const response = await fetch(
					`https://web-story-api.onrender.com/api/post/postDetails/${id}`
				);
				if (response.ok) {
	...
	const handlePost = async () => {
		...
		try {
			...
			const response = await fetch(
				`https://web-story-api.onrender.com/api/post/add`,
				{
					method: "POST",
					headers: {
	...
	const handleUpdate = async () => {
		...
		try {
			...
			const response = await fetch(
				`https://web-story-api.onrender.com/api/post/edit/${id}`,
				{
					method: "PUT",
					headers: {
						"Content-Type": "application/json",
